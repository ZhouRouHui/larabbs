...
return array(
     ...
     * @type string
     */
    'title' => env('APP_NAME', 'Laravel'),  // 应用名称，在页面标题和左上角站点名称处显示
     ...
     * @type string
     */
    'model_config_path' => config_path('administrator'),    // 模型配置信息文件存放目录
     ...
     * @type string
     */
    'settings_config_path' => config_path('administrator/settings'),    // 配置信息文件存放目录
